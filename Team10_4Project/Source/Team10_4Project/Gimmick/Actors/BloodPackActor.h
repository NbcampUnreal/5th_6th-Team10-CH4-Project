...
#include "BloodPackActor.generated.h"

UCLASS()
class TEAM10_4PROJECT_API ABloodPackActor : public AActor, public IInteractable // Interatable 인터페이스 상속
{
	GENERATED_BODY()
	
#pragma region Default Functions (ABloodPackAtor(), BeginPlay(), Tick(float DeltaTime)
public:	
