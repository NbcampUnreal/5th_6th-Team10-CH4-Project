...
#include "FirstAidActor.generated.h"

UCLASS()
class TEAM10_4PROJECT_API AFirstAidActor : public AActor, public IInteractable // Interatable 인터페이스 상속
{
	GENERATED_BODY()
	
#pragma region Default Functions (AFirstAidActor(), BeginPlay(), Tick(float DeltaTime)
public:	
...
protected:
	...
	TSubclassOf<class UGameplayEffect> GEClassFirstAid;
#pragma endregion
